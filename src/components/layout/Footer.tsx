  ...
  return (
    <footer className="mt-auto border-t border-white/10 bg-(--surface)/30 backdrop-blur-sm">
      <div className="container-max space-y-1 py-4 text-center text-xs text-white/60 sm:text-sm">
        ...
        <p className="text-white/50">Copyright © 2025 SFMHub. All rights reserved.</p>
        ...
        <p className="text-white/50">
          This website does not own or claim ownership of any content posted on it; all content has
          been provided by registered users.
        </p>
      </div>
    </footer>
  );
