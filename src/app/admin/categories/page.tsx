    ...
    <div className="space-y-6">
      <div className="space-y-1">
        ...
        <p className="text-sm text-white/60">
          Create and manage categories for new posts. Categories are maintained by moderators and
      ...
      <Card className="flex items-center gap-3 border border-green-500/30 bg-green-500/10 p-4 text-sm text-white/80">
        ...
        <p>
          To delete a category, make sure no posts are assigned to it. Categories with existing
          posts are protected from removal.
        </p>
      </Card>
